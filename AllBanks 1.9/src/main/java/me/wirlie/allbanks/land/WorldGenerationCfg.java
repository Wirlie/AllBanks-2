...
public class WorldGenerationCfg {
	...
	WorldGenerationCfg(String worldID){
		...
		Material road_material_try = Material.getMaterial(cfg.getString("road-material", "undefined"));
		...
		TreeType tryType1 = TreeType.valueOf(cfg.getString("generate-tree-type.type-1", "undefined"));
		TreeType tryType2 = TreeType.valueOf(cfg.getString("generate-tree-type.type-2", "undefined"));
	
		if(tryType1 != null) tree_type_1 = tryType1;
		if(tryType2 != null) tree_type_2 = tryType2;
		
		Biome tryBiome = Biome.valueOf(cfg.getString("default-biome", "undefined"));
	...
	public static String makeNewDefaultGeneratorConfigurationFile(String worldID){
		...
		worldCfg.set("road-material", road_material_def);
		...
		worldCfg.set("generate-tree-type.type-1", tree_type_1_def);
		worldCfg.set("generate-tree-type.type-2", tree_type_2_def);
		worldCfg.set("default-biome", default_biome_def);
