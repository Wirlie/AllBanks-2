...
public class Util {
	...
	public static class ShorterMaterialNameUtil {
		...
		static Set<Material> blackList = new ImmutableSet.Builder<Material>()
		...
		static Map<String, String> itemNames = new ImmutableMap.Builder<String, String>()
				.put("AIR" , "Air")
				.put("STONE" , "Stone")
				...
				.put("DIAMOND_BARDING" , "DiamondBard")
				.put("LEASH" , "Leash")
				.put("NAME_TAG" , "NameTag")
				.put("COMMAND_MINECART" , "CommandMCart")
				.put("MUTTON" , "Mutton")
				...
				.put("RECORD_3" , "Record 3")
				.put("RECORD_4" , "Record 4")
				.put("RECORD_5" , "Record 5")
				.put("RECORD_6" , "Record 6")
				.put("RECORD_7" , "Record 7")
				.put("RECORD_8" , "Record 8")
				.put("RECORD_9" , "Record 9")
