...
public class BankSession {
	...
	/**
	 * Iniciar una nueva sesión ({@link me.wirlie.allbanks.tempdata.BankSession#startSession(UUID, BankSession) Método similar})".
	 ...
	 * @param bs - Datos de la sesión {@link me.wirlie.allbanks.tempdata.BankSession BankSession}
	...
	/**
	 * Obtener la sesión si es que existe ({@link me.wirlie.allbanks.tempdata.BankSession#getSession(UUID) Método similar}).
