...
public enum StringsID {
	...
	PLOT_LOCKETTE_PROTECTION_REMOVED(226),
	COMMAND_HELP_UPDATER_CHECK_UPDATES_DESC(227),
	COMMAND_HELP_UPDATER_DOWNLOAD_UPDATE_DESC(228),
	COMMAND_HELP_UPDATER_CURRENT_VERSION(229),
	COMMAND_UPDATER_UPDATER_DISABLED(230),
	COMMAND_UPDATER_FAIL_CHECK(231),
	COMMAND_UPDATER_FAIL_DOWNLOAD(232),
	COMMAND_UPDATER_NO_UPDATES(233),
	COMMAND_UPDATER_SUCCESS_DOWNLOAD(234),
	COMMAND_UPDATER_UPDATE_AVAILABLE(235),
	COMMAND_UPDATER_CHECK_VERSION_LABEL(236),
	UNKNOW(237),
	UPDATE_AVAILABLE(238),
	NO_UPDATES(239),
	COMMAND_PLOT_CLEAR_CONFIRM_MSG(240),
	ACCEPT(241),
	CANCEL(242),
	COMMAND_PLOT_CLEAR_INVALID_TOKEN(243),
	COMMAND_PLOT_CLEAR_CANCEL_SUCCESS(244),
	PLOT_REGENERATION_ANOTHER_JOB_IN_PROGRESS(245),
	PLOT_REGENERATION_IN_PROGRESS(246),
	PLOT_REGENERATION_COMPLETED(247),
	PLOT_REGENERATION_REGENERATING(248),
	SEE_TRANSACTIONS_BY(249),
	TRANSACTION_BY_HOUR(250),
	TRANSACTION_BY_DAY(251),
	TRANSACTION_BY_MONTH(252),
	TRANSACTION_BY_YEAR(253),
	TRANSACTION_BY_SHOP_OWNER(254),
	TRANSACTION_BY_TRANSACTION_PLAYER(255),
	TRANSACTION_BY_ITEM(256),
	GENERATING_LIST(257),
	YOU_ARE_RUNNING_A_INCOMPATIBLE_VERSION_PROCEED_WITH_CAUTION_ALLBANKS2_CANNOT_WORK(258),
	COMMAND_ITEMINFO_INVALID_ITEM(259),
	API_EVENT_CANCELLED_BY_ANOTHER_PLUGIN(260),
	;
