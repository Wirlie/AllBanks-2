...
public class WorldLoadAsync_1_10_R1 {
	...
	public static World createAsyncWorld(WorldCreator creator, final CommandSender sender, final WorldGenerationCfg wcfg){
		...
		net.minecraft.server.v1_10_R1.WorldType type = net.minecraft.server.v1_10_R1.WorldType.getType(creator.type().getName());
		...
		if (worlddata == null) {
			...
			WorldSettings worldSettings = new WorldSettings(
					...
					EnumGamemode.SURVIVAL, //Modo de juego, survival por defecto
